   ...
   return (
      <div className="w-full flex justify-between items-center border-b py-1.5 px-6 h-10">
         <div className="flex items-center gap-3">
            <span className="text-sm text-muted-foreground">{t('issueCount', { count })}</span>
         </div>
         ...
         <div className="flex items-center gap-1">
            ...
            <Button
               ...
               aria-label={t('cycleHeader.toggleInsights')}
            >
            ...
            <Button
               ...
               aria-label={t('cycleHeader.toggleCycleDetails')}
            >
