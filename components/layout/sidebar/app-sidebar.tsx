         ...
         <SidebarFooter>
            <div className="w-full flex flex-col gap-2">
               ...
               {open && (
                  <div className="group/sidebar relative flex flex-col gap-2 rounded-lg border p-4 text-sm w-full">
                     ...
                     <div className="text-balance text-lg font-semibold leading-tight group-hover/sidebar:underline">
                        {t('sidebar.openSourceTitle')}
                     </div>
                     <div>{t('sidebar.openSourceDescription')}</div>
                     <Link
                        target="_blank"
                        rel="noreferrer"
                     ...
                     >
                        <span className="sr-only">{t('sidebar.squareByLndevUi')}</span>
                     </Link>
               ...
               <a className="my-1.5" href="https://vercel.com/oss">
                  <img
                     alt={t('sidebar.vercelOssProgram')}
