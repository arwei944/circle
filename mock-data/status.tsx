...
export const status: Status[] = [
   ...
   { id: 'done', name: '已完成', color: '#5e6ad2', category: 'completed', icon: DoneIcon },
   { id: 'paused', name: '已暂停', color: '#26b5ce', category: 'started', icon: PausedIcon },
   { id: 'to-do', name: '待办', color: '#99a2b2', category: 'unstarted', icon: ToDoIcon },
   { id: 'backlog', name: '待办', color: '#95a2b3', category: 'backlog', icon: BacklogIcon },
   { id: 'triage', name: '待归类', color: '#f2790f', category: 'triage', icon: TriageIcon },
   { id: 'idea', name: '想法', color: '#5e6ad2', category: 'backlog', icon: IdeaIcon },
   {
      id: 'product-feedback',
      name: '产品反馈',
      color: '#f2994a',
   ...
   { id: 'blocked', name: '已阻塞', color: '#eb5757', category: 'started', icon: BlockedIcon },
   { id: 'shipped', name: '已发布', color: '#4cb782', category: 'completed', icon: ShippedIcon },
   { id: 'canceled', name: '已取消', color: '#95a2b3', category: 'canceled', icon: CanceledIcon },
   {
      id: 'duplicate',
      name: '重复',
      color: '#95a2b3',
